...
class Cliente extends Conexion
{
    ...
    {
        $sql = "INSERT INTO clientes(cliente_nombre, cliente_apellido, cliente_genero, cliente_correo, cliente_telefono) VALUES ('$this->cliente_nombre','$this->cliente_apellido','$this->cliente_genero', '$this->cliente_correo', '$this->cliente_telefono')";
    ...
    public function buscar()
    {
        ...
        if ($this->cliente_correo != '') {
            $sql .= " and cliente_correo = '%$this->cliente_correo%' ";
        }
    ...
    {
        $sql = "UPDATE clientes SET cliente_nombre = '$this->cliente_nombre', cliente_apellido = '$this->cliente_apellido', cliente_correo = '$this->cliente_correo', cliente_telefono = '$this->cliente_telefono', cliente_genero = '$this->cliente_genero'  where cliente_id = $this->cliente_id";
