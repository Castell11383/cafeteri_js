...
abstract class Conexion
{
    ...
    public static function connectar(): PDO
    {
        if (!self::$conexion) {
            ...
            try {
                self::$conexion = new PDO("informix:host=host.docker.internal; service=9088;database=cafeteria; server=informix; protocol=onsoctcp;EnableScrollableCursors=1", "informix", "in4mix");
